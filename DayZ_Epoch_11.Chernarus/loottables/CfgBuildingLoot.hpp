...
class CfgBuildingLoot {
	...
	class Residential: Default {
		...
		lootType[] = {
			...
			{"ItemKnife","generic",0.14},
			{"ItemMatchbox_DZE","generic",0.11},
			{"","generic",0.32},
			{"backpacks","backpacks",0.14},
			{"tents","tents",0.11},
			{"","military",0.12},
			{"","trash",0.01},
			{"Binocular","weapon",0.02},
			{"PartPlywoodPack","magazine",0.08},
			{"clothes","clothes",0.21},
			{"specialclothes","specialclothes",0.11},
			{"WeaponHolder_MeleeCrowbar","object",0.13},
			{"pistols", "cfglootweapon", 0.24 },
			{"shotgunsingleshot", "cfglootweapon", 0.14 }
		};
		lootTypeSmall[] = {
			{ "ItemSodaMdew","magazine",0.11 },
			{ "ItemSodaRbull","magazine",0.11 },
			{ "ItemSodaOrangeSherbet","magazine",0.01 },
			{ "ItemWatch","weapon",0.01 },
			{ "ItemCompass","weapon",0.14 },
			{ "ItemMap","weapon",0.01 },
			{ "pistols","cfglootweapon",0.22 },
			{ "ItemFlashlight","weapon",0.01 },
			{ "ItemKnife","weapon",0.14 },
			{ "ItemMatchbox_DZE","weapon",0.13 },
			{ "","generic",0.38 },
			{ "","military",0.14 },
			{ "","trash",0.01 },
			{ "Binocular","weapon",0.12 },
			{ "clothes","single",0.11},
			{ "specialclothes","single",0.11 }
		};
	};
	class Office: Default {
		...
		lootTypeSmall[] = {
			...
			{ "ItemCompass","weapon",0.14 },
			{ "ItemMap","weapon",0.01 },
			{ "pistols","cfglootweapon",0.25 },
			{ "ItemFlashlight","weapon",0.01 },
			{ "ItemKnife","weapon",0.15 },
			{ "ItemMatchbox_DZE","weapon",0.13 },
			{ "","generic",0.31 },			
			{ "","military",0.14 },
			{ "","trash",0.01 },
			{ "Binocular","weapon",0.12 },
			{ "clothes","single",0.26 },
			{ "specialclothes","single",0.12 },
			{ "ItemDocument","magazine",0.11 }
		};
	};
	class Industrial: Default {
		...
		lootType[] = {
			...
			{"ItemFuelBarrelEmpty","magazine",0.11},
			{"","generic",0.17},
			{"","trash",0.01},
			{"","military",0.14},
			{"PartGeneric","magazine",0.14},
			{"PartWheel","magazine",0.15},
			{"PartFueltank","magazine",0.12},
			{"PartEngine","magazine",0.12},
			{"PartGlass","magazine",0.14},
			{"PartVRotor","magazine",0.11},
			{"ItemJerrycan","magazine",0.14},
			{"WeaponHolder_ItemHatchet_DZE","object",0.17},
			{"ItemKnife","military",0.17},
			{"ItemToolbox","weapon",0.16},
			{"ItemWire","magazine",0.11},
			{"ItemTankTrap","magazine",0.14},
			{"ItemKeyKit","weapon",0.01},
			{"CinderBlocks","magazine",0.13},
			{"MortarBucket","magazine",0.11}
		};
		lootTypeSmall[] = {
			{ "","generic",0.5 },
			{ "","trash",0.01 },
			{ "","military",0.14 },
			{ "ItemKnife","weapon",0.17 },
			{ "ItemKeyKit","weapon",0.01 }
		};
	};
	...
	class Farm: Default {
		...
		lootType[] = {
			...
			{"","generic",0.3},
			{"","trash",0.01},
			{"PartPlankPack","magazine",0.16},
			{"WeaponHolder_ItemHatchet_DZE","object",0.15},
			{"ItemFuelBarrelEmpty","magazine",0.11},
			{"WeaponHolder_ItemMachete","object",0.13},
			{"ItemFishingPole","weapon",0.12},
			{"ItemLightBulb","magazine",0.02},
			{"ItemSledgeHandle","magazine",0.12},
	...
	class Supermarket: Default {
		...
		lootType[] = {
			...
			{"ItemSodaOrangeSherbet","magazine",0.01},
			{"ItemWatch","generic",0.01},
			{"ItemCompass","generic",0.12},
			{"ItemMap","weapon",0.01},
			{"ItemFlashlight","generic",0.01},
			{"ItemKnife","generic",0.12},
			{"ItemMatchbox_DZE","generic",0.14},
			{"","generic",0.14},
		...
		lootTypeSmall[] = {
			...
			{ "ItemMap","weapon",0.01 },
			{ "pistols","cfglootweapon",0.18 },
			{ "ItemFlashlight","weapon",0.01 },
			{ "ItemKnife","weapon",0.12 },
			{ "ItemMatchbox_DZE","weapon",0.14 },
			{ "","generic",0.21 },
			{ "","food",0.54 },
			{ "","trash",0.01 },
			{ "Binocular","weapon",0.02 },
			{ "ItemMixOil", "magazine",0.22}
		};
	};
	class HeliCrash: Default {
		...
		lootPos[] = {};
		lootType[] = {
			{ "assaultrifles", "cfglootweapon", 0.90 },
			{ "submachinegun", "cfglootweapon", 0.94 },
			{ "sniperrifles", "cfglootweapon", 0.97 },
			{ "machineguns", "cfglootweapon", 0.96 },
			{"","military",0.3},
			{"","medical",0.98},
			{"MAAWS","weapon",0.62},
			{"MedBox0","object",0.25},
			{"NVGoggles","weapon",0.01},
			{"AmmoBoxSmall_556","object",0.33},
			{"AmmoBoxSmall_762","object",0.33},
			{"militaryclothes","militaryclothes",0.35},
			{"militaryammo","militaryammo",0.36}
		};
	};
	class HeliCrash_No50s: Default {
		...
		lootType[] = {
			...
			{ "AmmoBoxSmall_556", "object", 0.33 },
			{ "AmmoBoxSmall_762", "object", 0.33 },
			{ "militaryclothes", "militaryclothes", 0.25 },
			{ "militaryammo", "militaryammo", 0.26 }
		};
	};
	...
	class Military: Default {
		...
		lootPos[] = {};
		lootType[] = {
			{ "pistols", "cfglootweapon", 0.64},
			{ "assaultrifles", "cfglootweapon", 0.73 },
			{ "sniperrifles", "cfglootweapon", 0.94 },
			{ "shotgunsingleshot", "cfglootweapon", 0.46 },
			{ "submachinegun", "cfglootweapon", 0.67 },
			{"Binocular","weapon",0.03},
			{"ItemFlashlightRed","military",0.01},
			{"ItemKnife","military",0.01},
			{"ItemGPS","weapon",0.01},
			{"ItemMap","military",0.01},
			{"militarybackpacks","militarybackpacks",0.35},
			{"","medical",0.01},
			{"","generic",0.0},
			{"","military",0.3},
		...
		lootTypeSmall[] = {
			...
			{ "Binocular", "weapon", 0.05 },
			{ "ItemFlashlightRed", "weapon", 0.00 },
			{ "ItemKnife", "weapon", 0.00 },
			{ "ItemGPS", "weapon", 0.02 },
			{ "", "medical", 0.00 },
			{ "", "generic", 0.00 },
			{ "", "military", 0.07 },
			{ "ItemEtool", "weapon", 0.00 }
		};
	};
	...
	class IndustrialMilitary: Default {
		...
		lootType[] = {
			{ "pistols", "cfglootweapon", 0.42 },
			{ "assaultrifles", "cfglootweapon", 0.85 },
			{ "PartGeneric", "magazine", 0.00 },
			{ "sniperrifles", "cfglootweapon", 0.71 },
			{ "shotgunsingleshot", "cfglootweapon", 0.25 },
			{ "ItemGenerator", "magazine", 0.01 },
			{ "submachinegun", "cfglootweapon", 0.45 },
	...
	class MilitarySpecial: Default {
		...
		lootPos[] = {};
		lootType[] = {
			{ "assaultrifles", "cfglootweapon", 0.9 },
			{ "machineguns", "cfglootweapon", 0.24 },
			{ "pistols", "cfglootweapon", 0.28 },
			{ "sniperrifles", "cfglootweapon", 0.73 },
			{ "militaryshotguns", "cfglootweapon", 0.25 },
			{ "submachinegun", "cfglootweapon", 0.36 },
			{"AmmoBoxSmall_556","object",0.11},
			{"AmmoBoxSmall_762","object",0.12},
			{"Binocular","weapon",0.01},
			{"ItemFlashlightRed","military",0.01},
			{"ItemKnife","military",0.01},
			{"ItemGPS","weapon",0.01},
			...
			{"militarybackpacks","militarybackpacks",0.14},
			{"","medical",0.01},
			{"","generic",0.01},
			{"","military",0.01},
			{"machinegunammo","machinegunammo",0.01},
			{"militaryclothes","militaryclothes",0.15},
			{"NVGoggles","weapon",0.01}
		};
		lootTypeSmall[] = {
			{ "pistols","cfglootweapon",0.40 },
			{ "AmmoBoxSmall_556","object",0.22 },
			{ "AmmoBoxSmall_762","object",0.22 },
			{ "Binocular","weapon",0.00},
			{ "ItemFlashlightRed","military",0.00},
			{ "ItemKnife","military",0.00},
			{ "ItemGPS","weapon",0.01 },
			{ "ItemMap","weapon",0.01 },
			...
			{ "","generic",0.01},
			{ "","military",0.01 },
			{ "5Rnd_86x70_L115A1","magazine",0.13},
			{ "10Rnd_127x99_m107","magazine",0.12},
	...
	class Hunting: Default {
		...
		lootType[] = {
			{"ItemMap","weapon",0.01},
			{"ItemFlashlight","generic",0.01},
			{"ItemKnife","generic",0.11},
			{"ItemMatchbox_DZE","generic",0.13},
			{ "farmweapons", "cfglootweapon", 0.23 },
			{"","military",0.38},
			{"WeaponHolder_ItemMachete","object",0.12},
			{"","hunter",0.5}
		};
		lootTypeSmall[] =	{
			{"ItemMap","weapon",0.01},
