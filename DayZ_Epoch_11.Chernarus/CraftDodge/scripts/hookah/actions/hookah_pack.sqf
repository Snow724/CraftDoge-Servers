...
if(DZE_ActionInProgress) exitWith { cutText ["hookah breakdown already in progress." , "PLAIN DOWN"]; };
DZE_ActionInProgress = true;

player removeAction s_player_packHookah;
s_player_packHookah = 1;

_obj = _this select 3;

cutText ["Breakdown of Hookah started", "PLAIN DOWN"];
...
if (_finished) then {
	...
	cutText ["Canceled breakdown of hookah", "PLAIN DOWN"];
};
