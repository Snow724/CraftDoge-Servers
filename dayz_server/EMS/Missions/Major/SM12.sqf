...
_vehicle1 = createVehicle ["HMMWV_Ambulance",[(_coords select 0) + 20, (_coords select 1) - 5,0],[], 0, "CAN_COLLIDE"];
_vehicle2 = createVehicle ["HMMWV_Ambulance",[(_coords select 0) + 30, (_coords select 1) - 5,0],[], 0, "CAN_COLLIDE"];
