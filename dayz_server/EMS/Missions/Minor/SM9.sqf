...
//Name of the Mission
_missName = "Rebel Gang";

//DZMSFindPos loops BIS_fnc_findSafePos until it gets a valid result
_coords = call DZMSFindPos;

[nil,nil,rTitleText,"A Rebel Gang has Begun Terrorizing the Area, Find Them and Take Back your Territory", "PLAIN",10] call RE;
...
[nil,nil,rTitleText,"You are once again on top!", "PLAIN",6] call RE;
