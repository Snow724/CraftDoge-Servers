...
/*  SUPER ADMIN HERE      */ _SAdmins = ["130322566","254304646","243070534","107705030","68054150","81938438","167073798","76609606","64895174","67889542"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED = ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "CraftDoge"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "www.craftdoge.com"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "ts.craftdoge.com"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0,1,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "CraftDoge.com"; //do not use " in this text.
