...
server_logUnlockLockEvent = {
	...
	Napf: 2
	*/
	if(CD_Buildings) then 
	{
		if (CraftDodge_ID in [1]) then {
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\caves.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\CDC_Balota.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\dk_GrassCutter.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\GOC_TE_btcc.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\GOC_TE_htlh.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\golden_river.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\HEMP.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\NEAF.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\NWAF.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\NWAF_Hollow.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\Prud_Cave.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\Secret_Airfield.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\South_Cave.sqf";
			diag_log(":: CraftDodge Building Additons FULLY CONSTRUCTED Chernarus");

		};
		if (CraftDodge_ID in [2]) then {
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\AGS_SnowBridge_NAPF.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\AGS_ArmaIsland_NAPF.sqf";
		call compile preProcessFileLineNumbers "\z\addons\dayz_server\maps\AGS_ArmaIslandOF_NAPF.sqf";


			diag_log(":: CraftDodge Building Additons FULLY CONSTRUCTED Napf");
